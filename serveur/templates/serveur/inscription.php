...
<h3><label>Confirmation de votre mot de passe:<input type="password" name="pass" id="pass"required/></label></h3>
<h3><label>Adresse electronique:<input type="email" name="pseudo" id="pseudo" placeholder="Ex : Paul984@free.fr" size="30" required/></label></h3>
