		...
		<div class="container"> <!-- Fin dans le footer-->
			<div class="starter-template">
				<div class="row">
					...
					<div class="col-md-6">
						<a href="index.php" class="btn btn-info btn-block cat active" role="button">Sportives</a>	    <!-- Ce bouton permet de rediriger vers un lien-->
					</div>
					
					<div class="col-md-6">
						<button class="btn btn-success btn-block cat">Berlines</button>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<button class="btn btn-danger btn-block cat">SUV et 4x4</button>	
					</div>
					
					<div class="col-md-6">
						<button class="btn btn-default btn-block cat">Breaks</button>
					</div>
