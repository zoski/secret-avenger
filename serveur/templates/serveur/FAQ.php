	...
	<h1 >Foire Aux Questions: </h1>
		...
		<div>
			<div class="questions" > Comment ça marche  ? </div>
				<p >Notre site fonctionne de la manière suivante. Vous pouvez acheter ou recommander différents produits ou services. Lorsque vous êtes à la recherche d'un objet, notre site choisira les sites vendeurs les plus recommandés par les internautes, afin d'avoir le meilleur rapport qualité-prix, et le plus proche de vos désirs.</p>
				
			<div class="questions" > En quoi ce site diffère-t-il des autres ?</div>
				<p>Notre concept est unique, c'est-à-dire que le client est au centre de la démarche d'achat et non le produit.</p>
				
			<div class="questions" > Comment s'inscrire ?</div>
				<p >Pour vous inscrire, vous aurez besoin d'un pseudonyme et d'un mot de passe lié à celui-ci, ainsi qu'une adresse e-mail valide. Vous pouvez cliquer  <a href="inscription.php" title="Cliquez ici pour vous inscrire">ici</a>  pour vous inscrire, ou simplement aller sur la page d'accueil.</p>
