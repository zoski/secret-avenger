...
<?php include "includes/navigation.php" ?>
	...
	<h1 >Foire Aux Questions: </h1>
		...
		<div>
			...
			<p class="questions" >En quoi ce site diffère-t-il des autres ?</p>
				<p>Notre concept est unique, c'est a dire que le client est au centre de la démarche d'achat et non le produit.</p>
			<p class="questions" >Comment s'inscrire ?</p>
				<p >Pour vous inscrire, vous aurez besoin d'un pseudonyme et d'un mot de passe lié a celui ci, ainsi qu'une adresse e-mail valide. Vous pouvez	<a href="inscription.php">cliquer ici (bulle d'aide + lien ) pour vous inscrire</a> , ou simplement aller sur la page d'accueil.</p>
			<p class="questions">Je me suis inscrit mais je ne reçois pas d'e-mail de confirmation... </p>
			...
			<p class="questions">Comment acheter ?</p>
				<p> Dans la page d'accueil, vous aurez le choix entre deux possibilités. Si vous souhaitez acheter un objet, dirigez-vous vers la partie gauche (en bleue) de l'écran d'accueil. Il vous suffira ensuite de suivre la démarche a l'écran en indiquant par exemple le nom de l'objet ainsi que les critèresauxquels il doit répondre.</p>
			<p class="questions">Vais-je acheter sur le site ? </p>
				<p>Non, lorsque vous aurez choisi votre achat, notre site choisira pour vous le site web le plus avantageux et proche de vos désirs. Il vous suffira ensuite de </p>er sur le lien et de suivre les instructions d'achat de votre objet.</p>
			<p class="questions">Comment recommander ?</p>
				<p>Pour recommander, il suffira de vous diriger vers la partie droite de l'écran d'accueil (en rouge) .il faut au préalable posséder un compte sur notre site. Pas de panique, vous pouvez </p>er ici (lien + bulle d'aide) pour créer un compte, cliquer ici(lien + bulle d'aide) pour obtenir de plus amples informations.</p>
